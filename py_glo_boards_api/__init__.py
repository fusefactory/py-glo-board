...
class GloBoard:
    ...
    # Milestone
    def create_milestone(self, board_id, milestone_name, due_date, description=None):
        milestone = api.create_milestone(self.token, board_id, milestone_name, due_date, description)
        return types.Milestone.de_json(milestone)
    def delete_milestone(self, board_id, milestone_id):
        result = api.delete_milestone(self.token, board_id, milestone_id)
        return result